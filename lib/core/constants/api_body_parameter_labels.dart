...
const studyProgramKey = 'study_program';
const specializationKey = 'specialization';
const semesterKey = 'semester';
const universityNameKey = 'university_name';
const universityCodeKey = 'university_code';
const firstLoginCompleteKey = 'first_login_complete';
