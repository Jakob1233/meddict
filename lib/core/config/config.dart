...
/// === Config ===
const appName = 'meddict';
const packageName = 'pleiner.jakob.meddictapp';
...
final TextStyle kFonts = GoogleFonts.inter();
final TextTheme kTextTheme = GoogleFonts.interTextTheme();
