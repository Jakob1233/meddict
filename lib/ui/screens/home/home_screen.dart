              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: List.generate(
                    battleZones.length,
                    (i) {
                      final zone = battleZones[i];
                      final background = _homeCardBackgrounds[zone.title];
                      final title = context.tr(zone.title)!;
                      final desc = context.tr(zone.desc)!;
                      final card = QuizGridCard(
                        onTap: () => _onPressedBattle(zone.title),
                        title: title,
                        desc: desc,
                        img: zone.img,
                        backgroundSvg: background,
                        showSubtitle: background == null,
                      );
              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: List.generate(
                    examZones.length,
                    (i) {
                      final zone = examZones[i];
                      final background = _homeCardBackgrounds[zone.title];
                      final title = context.tr(zone.title)!;
                      final desc = context.tr(zone.desc)!;
                      final card = QuizGridCard(
                        onTap: () => _onPressedSelfExam(zone.title),
                        title: title,
                        desc: desc,
                        img: zone.img,
                        backgroundSvg: background,
                          ...
                          if (!_isGuest)
                            Padding(
                              ...
                              child: ElevatedButton.icon(
                                ...
                                label: Text(context.tr('leaderboardLbl')!),
                              ),
                            ),
                          if (!_isGuest &&
