...
class ProfileManagementRemoteDataSource {
  ...
  Future<void> updateProfile({
    ...
    try {
      ...
      if (studyProgram != null) {
        body[studyProgramKey] = studyProgram;
      }
      if (specialization != null) {
        body[specializationKey] = specialization;
        body.putIfAbsent(studyProgramKey, () => specialization);
      }
      if (semester != null) {
        body[semesterKey] = semester;
      }
      if (universityName != null) {
        body[universityNameKey] = universityName;
      }
      if (universityCode != null) {
        body[universityCodeKey] = universityCode;
      }
      if (firstLoginComplete != null) {
        body[firstLoginCompleteKey] = firstLoginComplete ? '1' : '0';
      }
  ...
  Future<bool> isUsernameAvailable(String username) async {
    try {
      final response = await http.post(
        Uri.parse(checkUsernameAvailabilityUrl),
        body: {usernameKey: username},
        headers: await ApiUtils.getHeaders(),
      );
      final responseJson = jsonDecode(response.body) as Map<String, dynamic>;
